...
import { getProjects } from "../../../sanity/utils/projects";
...
export const metadata: Metadata = {
    ...
    openGraph: {
        type: 'website',
        locale: 'no_NO',
        siteName: 'My projects - DevShaded',
        title: 'My projects - DevShaded',
        description: 'The Fullstack Web Developer from Norway, here is the official portfolio for DevShaded',
        images: [
            {
...
export default async function Projects() {
    ...
    return (
        <SimpleLayout
            title="Things I've made on my spare time."
            intro="Here you can find some projects I've made on my spare time. You can find more projects on my GitHub if I haven't updated this page."
        >
            <ul
                role="list"
            ...
            >
                {projects.map((project) => (
                    <Card as="li" key={project.projectName}>
                        <div
                            ...
                            <ImageComponent name={project.projectName} image={project.projectImage} width={200}
                                            height={200}/>
                        </div>
                        <h2 className="mt-6 text-base font-semibold text-zinc-800 dark:text-zinc-100">
                            <Card.Link href={project.projectLink}>{project.projectName}</Card.Link>
                        </h2>
                        <Card.Description>{project.projectDescription}</Card.Description>
                        <p
                            ...
                            <span className="ml-2">{project.projectLabel}</span>
                        </p>
                    </Card>
                ))}
            </ul>
