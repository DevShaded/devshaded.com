      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <p className="mt-4 text-base text-gray-600 dark:text-gray-400">
            You can contact me either by email or by sending me a message on LinkedIn! I&apos;ll try to respond as soon
            as possible.
          </p>
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-3">
              <div>
                ...
                <p className="mt-4 leading-7 text-gray-600 dark:text-gray-200">
                  Here are some ways you can get in touch with me. I&apos;ll try to respond as soon as possible.
                </p>
              </div>
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:col-span-2 lg:gap-8">
                <div className="rounded-2xl bg-gray-50 p-10 dark:bg-gray-800">
                  <h3 className="text-base font-semibold leading-7 text-gray-900 dark:text-white">My email</h3>
